      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg bg-slate-900 text-white font-medium hover:bg-slate-800 transition-colors border border-slate-600"
          >
            <GitHubIcon />
